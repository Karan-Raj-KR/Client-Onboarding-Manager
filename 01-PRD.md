# Product Requirements Document — KĀRYO
...
4. KĀRYO calculates amounts and generates a branded quotation PDF plus public acceptance link.
5. Client accepts the quotation.
6. KĀRYO marks the deal won, creates a GST-ready invoice PDF, creates a Razorpay/UPI payment-link record, schedules reminders, and refreshes dashboard totals.
