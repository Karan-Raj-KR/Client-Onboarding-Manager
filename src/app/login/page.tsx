      ...
      <div className="bg-white rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.06)] border border-border/40 p-8 w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 px-6 bg-white hover:bg-neutral-50 text-neutral-900 font-bold rounded-xl border border-border transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center space-x-3 shadow-sm"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-muted-foreground font-bold tracking-wider">Or continue with email</span>
            </div>
          </div>
        </div>
